<style>
.demo-basic{ display: flex; justify-content: space-between; }
</style>
<template>
    <div>
        <h4>基本</h4>
        ...
        <div class="demo-basic">
            ...
            <Date-picker type="date" placeholder="选择日期" style="width: 160px;display: inline-block"></Date-picker>
            <i-input style="width: 100px"></i-input>
            <i-input type="text" placeholder="Username" style="width: 200px">
                <Icon type="ios-person-outline" slot="prepend"></Icon>
            </i-input>
            <i-button type="primary">按钮</i-button>
            <!-- http://vuejs.org/guide/migration.html#v-bind-with-once-and-sync-Modifiers -->
            <i-select :model="model1" style="width:200px">
                <i-option @on-select-selected="selected" v-for="item in cityList" :value="item.value">{{ item.label }}</i-option>
            </i-select>
        </div>
        <br><br>
